    ...
    static let all: [Building] = [
        ...
        Building(name: "立誠樓",
                 ...
                 classrooms: [
                     ...
                     (floor: "3F", rooms: ["4306訊號與影像處理實驗室"]),
                     (floor: "4F", rooms: ["4401A基礎通訊實驗室","4405低軌衛星實驗室"]),
                     (floor: "5F", rooms: ["4501DSP實驗室","4502印刷電路製作室","4507電子實驗室"])
                 ]),
        Building(name: "致遠樓",
                 ...
                 icon: "building",
                  color: Color.gray,
                 classrooms: [
                     (floor: "1F", rooms: ["3102多功能休閒遊憩專業教室","3103觀光導覽專業教室","3105教室","3106海洋資源管理專業教室"]),
                     (floor: "2F", rooms: ["3201專業教室","3202教室","3203教室","3204教室","3205教室","3206教室"]),
                     (floor: "4F", rooms: ["3401商資科技教學中心","3409教室"]),
        ...
        Building(name: "寰宇樓",
                 ...
                 icon: "building",
                  color: Color.gray,
                 classrooms: [
                     (floor: "1F", rooms: ["2102英語教學教室","2104語言學習園區","2105郵輪與遊艇研討會","2108會議展覽研究室"]),
                     (floor: "2F", rooms: ["2202教室","2203實驗室","2204階梯教室","2206教室","2209專題教室","2210專題教室"]),
                     (floor: "3F", rooms: ["2304資訊科技研討室","2310教室"]),
                     (floor: "4F", rooms: ["2401教室","2402教室","2403商資應用教學中心","2407管理科學研習教室","2408商務知能創新中心"]),
        ...
        Building(name: "大仁樓",
                 ...
                 icon: "building",
                  color: Color.gray,
                 classrooms: [
                     (floor: "1F", rooms: ["6104通用技能實驗室","6105儀控整合實驗室","6106/6107製程設備實驗室","6108真空系統實驗室"]),
        ...
        Building(name: "大信樓",
                 ...
                 classrooms: [
                     ...
                     (floor: "2F", rooms: ["7202教室","7203教室","7204教室","7205微型教室","7208教室"]),
                     (floor: "3F", rooms: ["7301短期學者訪問室","7304海環大會議室"]),
                     (floor: "4F", rooms: ["7402會議室"]),
        ...
        Building(name: "海天樓",
                 ...
                 icon: "building",
                  color: Color.gray,
                 classrooms: [
                     (floor: "1F", rooms: ["10101教室","10102教室","10103教室","10104教室","10105教室","10106教室","10107教室"]),
                     (floor: "2F", rooms: ["10201教室","10202教室","10203教室","10204教室","10205教室","10206教室","10207教室","10208教室"]),
                     (floor: "3F", rooms: ["A301教室","A302教室","A305教室","10307階梯教室"]),
                     (floor: "4F", rooms: ["10401多媒體教室","10403藝文教室","10405階梯教室"])
                 ]),
        Building(name: "藝文中心",
        ...
        Building(name: "厚生樓",
                 ...
                 classrooms: [
                     ...
                     (floor: "2F", rooms: ["A11203漁管系會議室","A11212-5水食系會議室","212-3專業教室A","212-4專業教室B","A11213-5水產生物實驗室","213-6漁航科技實驗室","240-1專業教室C","240-2專業教室D"]),
        ...
        Building(name: "樂群樓",
                 ...
                 classrooms: [
                     ...
                     (floor: "5F", rooms: ["8504水質分析實驗室","8508水產動物病理實驗室","8501研究室","8506研究室"])
                 ]),
        Building(name: "英才樓",
