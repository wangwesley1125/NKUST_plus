    ...
    static let all: [Building] = [
        ...
        Building(name: "創新設計學院(原人文社會學院)",
                  ...
                  classrooms: [
                      ...
                      (floor: "3F", rooms: ["HS303","HS304","HS305","HS313","HS314","HS315","HS316","HS319","HS327","HS328"]),
        ...
        Building(name: "商業智慧學院(原管院一館)",
                  coordinate: CLLocationCoordinate2D(latitude: 22.773523453519473, longitude: 120.40306334808744),
                  description: "",
                  icon: "building",
                   color: Color.gray,
                  classrooms: [
                    (floor: "1F", rooms: ["MA104","MA106","MA108","MA112","MA114","MA115"]),
                    (floor: "2F", rooms: ["MA202","MA203","MA205","MA206","MA207","MA208","MA209","MA211","MA212","MA213","MA215","MA216","MA217B","MA218"]),
